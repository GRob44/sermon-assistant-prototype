...
st.title("AI Ministry Conversational Assistant (ChatGPT Style)")
...
if user_input:
    ...
    with st.chat_message("assistant"):
        ...
        # Token & cost info inside the message too
        st.info(f"🔢 Tokens Used: Input: {input_tokens} | Output: {output_tokens}")
